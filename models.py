...
class FactorizedRNN(nn.Module):
    ...
    def __init__(self, layers_size=[10,2], nb_samples=1, emb_size=10, data_dir ='.'):
        ...
        #self.conv2 = nn.Conv1d(in_channels = 1,out_channels = 1,kernel_size=20,stride = 10)
        #self.conv2 = nn.Conv1d(in_channels = 1,out_channels = 1,kernel_size = 5,stride = 2)
        #self.conv3 = nn.Conv1d(in_channels = 1,out_channels = 1,kernel_size
        #                       =6,stride = 1)
